...
export default function HomePage() {
  return (
    <>
      {/* Hero */}
      <section className="relative bg-gradient-to-br from-sage-50 via-warm-50 to-lilac-50 min-h-[90vh] flex items-center overflow-hidden">
        {/* Decorative circles */}
        <div className="absolute top-20 right-0 w-96 h-96 bg-lilac-100/40 rounded-full blur-3xl -translate-y-1/2 translate-x-1/3" />
        <div className="absolute bottom-0 left-0 w-80 h-80 bg-sage-100/50 rounded-full blur-3xl translate-y-1/3 -translate-x-1/4" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-warm-900 leading-tight mb-6">
                Construí una vida{" "}
                <span className="text-sage-600">que valga la pena</span>{" "}
                vivir
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  ...
                  className="inline-flex items-center justify-center gap-2 bg-sage-500 hover:bg-sage-600 text-white font-medium px-7 py-3.5 rounded-full transition-colors shadow-md hover:shadow-lg text-base"
                >
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="relative bg-white rounded-3xl shadow-xl p-8 max-w-sm w-full border border-warm-100">
                <div className="w-20 h-20 bg-sage-100 rounded-full flex items-center justify-center text-4xl mx-auto mb-5">
                  🌱
                </div>
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    <li key={item} className="flex items-start gap-3 text-warm-600 text-sm">
                      <span className="mt-0.5 w-5 h-5 flex-shrink-0 bg-sage-100 text-sage-600 rounded-full flex items-center justify-center text-xs font-bold">✓</span>
                      {item}
                    </li>
                  ))}
                </ul>
                <Link
                  href="/servicios"
                  className="mt-6 block text-center text-sage-600 hover:text-sage-700 text-sm font-medium underline underline-offset-2"
                >
                  Ver servicios →
                </Link>
              </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {pillars.map((p) => (
              <div key={p.title} className="bg-warm-50 rounded-2xl p-6 border border-warm-100 hover:border-sage-200 hover:shadow-sm transition-all duration-200">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {steps.map((s) => (
              <div key={s.n} className="text-center">
                <div className="w-14 h-14 bg-sage-500 text-white rounded-full flex items-center justify-center text-lg font-bold mx-auto mb-4">
                  {s.n}
                </div>
          ...
          <div className="text-center mt-12">
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 bg-sage-500 hover:bg-sage-600 text-white font-medium px-8 py-3.5 rounded-full transition-colors shadow-md text-base"
            >
      ...
      {/* CTA banner */}
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-lilac-100 to-sage-100">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 bg-sage-500 hover:bg-sage-600 text-white font-medium px-7 py-3.5 rounded-full transition-colors shadow-md text-base"
            >
              Escribime ahora
            </Link>
            <Link
