    ...
    <div className="min-h-screen flex items-center justify-center bg-warm-50 px-4 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-warm-900">Crear cuenta</h1>
          <p className="text-warm-600 mt-2">Registrate como profesional</p>
        </div>
        ...
        <form action={action} className="bg-white rounded-2xl shadow-sm border border-warm-200 p-8 space-y-5">
          ...
          <div>
            ...
            <input
              ...
              type="text"
              required
              className="w-full px-4 py-2.5 rounded-lg border border-warm-300 focus:ring-2 focus:ring-sage-500 focus:border-sage-500 outline-none transition"
            />
          </div>
          ...
          <div>
            <label htmlFor="profession" className="block text-sm font-medium text-warm-700 mb-1">
              Profesión <span className="text-warm-400">(opcional)</span>
            </label>
            <input
              id="profession"
              name="profession"
          ...
          <div>
            <label htmlFor="licenseNumber" className="block text-sm font-medium text-warm-700 mb-1">
              Matrícula <span className="text-warm-400">(opcional)</span>
            </label>
            <input
              id="licenseNumber"
              name="licenseNumber"
          ...
          <button
            type="submit"
            disabled={pending}
            className="w-full bg-sage-600 hover:bg-sage-700 text-white font-medium py-2.5 px-4 rounded-lg transition disabled:opacity-50"
          >
