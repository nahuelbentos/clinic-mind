...
export default function NuevoObjetivoForm({
  patientId,
  parentId,
  parentDescription,
}: {
    ...
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <form action={action} className="space-y-6">
        ...
        {parentId && parentDescription && (
          <div className="bg-lilac-50 border border-lilac-200 text-lilac-800 px-4 py-3 rounded-lg text-sm">
            <span className="font-medium">{t("subgoalOf")}:</span> {parentDescription}
          </div>
        )}
