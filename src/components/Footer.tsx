    ...
    <footer className="bg-warm-100 border-t border-warm-200 mt-auto">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-brand-700 font-semibold text-lg mb-3">Lic. Micaela Vulcano</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {navLinks.map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="text-warm-600 hover:text-brand-600 text-sm transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-warm-600">
              <li>
                <a href="https://wa.me/5491100000000" target="_blank" rel="noopener noreferrer" className="hover:text-brand-600 transition-colors flex items-center gap-2">
